...
class ChangePassword {
    constructor(userStore, userIdGetter, hashAlgo, emailService) {
    ...
    changePassword(loggedInUserId, oldPassword, newPassword, confirmNewPassword) {
        if (!loggedInUserId) {
        ...
        try {
            ...
            const self = this;
            return co(function *() {
                const user = yield self.userStore.getById(loggedInUserId);
                if (!user) {
